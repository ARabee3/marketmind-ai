...
Use this note for service businesses — salons, home services (plumbing,
cleaning, repairs), and professional services (accounting, legal,
consulting, agencies) — where the "product" is the proprietor's time and
expertise and the bottleneck is booking, not stock.
...
1. **Capacity is appointment-count, not stock.** the real ceiling is the
...
This is a starting point, not a complete services strategy. Combine with
