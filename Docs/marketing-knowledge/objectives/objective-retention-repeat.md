...
Retention owns the repeat stage and feeds advocacy — repeat purchases,
return visits, and the share/review/referral behaviours that come from
...
bring-a-friend offer). The KPI is repeat-customer rate or return-visit rate,
measured against the baseline; advocacy is measured via reviews or
referrals as a secondary.

## Risks of choosing this objective when it doesn't fit

Choosing retention without a way to identify repeat customers produces an
unmeasurable plan and sends discount blasts to people who were never coming
