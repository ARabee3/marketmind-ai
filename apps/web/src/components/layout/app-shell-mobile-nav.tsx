    ...
    <>
      ...
      >
        <div className="mx-auto max-w-[1200px]">
          <ul className="mx-auto grid max-w-[1200px] grid-cols-6 items-center gap-1 px-2 pt-2 pb-1">
            {navItems.map((item) => {
              const active =
              ...
              return (
                <li key={item.href} className="min-w-0">
                  <Link
                    ...
                    className={cn(
                      "flex min-h-12 min-w-0 flex-col items-center justify-center gap-0.5 rounded-lg px-0.5 py-1 text-center text-[10px] leading-tight font-semibold outline-none transition-colors focus-visible:ring-2 focus-visible:ring-action",
                      active
