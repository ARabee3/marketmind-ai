...
const API_ERROR_CODE_TO_TRANSLATION: Record<ErrorCode, TranslationKey> = {
  ...
  OAUTH_ACCOUNT_SUSPENDED: "Auth.oauthAccountSuspendedTitle",
  OAUTH_ACCOUNT_DISABLED: "Auth.oauthAccountDisabledTitle",
  ...
  ORCHESTRATION_FEATURE_DISABLED: "Errors.generic",
  ORCHESTRATION_INVALID_TRANSITION: "Errors.generic",
  ORCHESTRATION_DUPLICATE_START: "Errors.generic",
  ORCHESTRATION_NOT_FOUND: "Errors.notFound",
  ORCHESTRATION_SCOPE_MISMATCH: "Errors.forbidden",
  ORCHESTRATION_STALE_RESUME: "Errors.generic",
  ORCHESTRATION_CHECKPOINT_FAILURE: "Errors.serverError",
  ORCHESTRATION_TOOL_NOT_ALLOWED: "Errors.validationError",
  ORCHESTRATION_BUDGET_EXCEEDED: "Errors.validationError",
  ORCHESTRATION_PROVIDER_UNSUPPORTED: "Errors.validationError",
  ORCHESTRATION_VALIDATION_FAILED: "Errors.validationError",
