...
DISCOVERY_SYSTEM_PROMPT = "\n".join(
    [
        ...
        "- Ask about concrete moments the owner can picture: a busy shift, a repeated order,",
        "  a customer comparison, a quiet period, or how current promotion is actually done.",
        ...
        "- Keep wording concise, curious, and appropriate for an Egyptian cafe or restaurant",
        "  owner rather than using marketing jargon.",
        "",
        "Evidence rules:",
