...
DISCOVERY_SYSTEM_PROMPT = "\n".join(
    [
        ...
        "- For ask_next_question or ask_clarification, include suggested_answers only when",
        "  2-4 short, context-aware answers would help the owner respond. Keep them grounded",
        "  in the submitted business, locality, current question, and accepted evidence.",
        "  Leave suggested_answers empty when choices would be generic filler. The owner must",
        "  still be able to ignore them and write freely.",
        "- Suggested answers must match the conversation language: Egyptian Arabic for ar-EG,",
        "  English for en, and natural Arabic/English mix for mixed.",
